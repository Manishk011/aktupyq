...
const ContactUs = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50">
            <SEO
                title="Contact AKTU PYQ — Report Issues, Contribute Resources"
                description="Get in touch with the AKTU PYQ team. Report broken links, suggest study materials, give feedback, or partner with us to help more students."
                canonicalUrl="https://www.aktupyq.com/contact"
            />
            <Header />
