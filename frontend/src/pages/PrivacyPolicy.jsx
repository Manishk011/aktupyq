...
const PrivacyPolicy = () => {
    return (
        <div className="min-h-screen bg-slate-50">
            <SEO
                title="Privacy Policy — AKTU PYQ"
                description="Read how AKTU PYQ handles your personal data, what we collect, why we collect it, and your rights as a user of our free study material platform."
                canonicalUrl="https://www.aktupyq.com/privacy"
            />
            <Header />
