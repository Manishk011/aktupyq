...
const AboutUs = () => {
    const orgSchema = {
        ...
        "@type": "Organization",
        "name": "AKTU PYQ",
        "url": "https://www.aktupyq.com",
        "description": "AKTU PYQ is a free study portal for AKTU B.Tech students providing previous year question papers, handwritten notes, quantum series, and official syllabus.",
        "foundingDate": "2025",
        "areaServed": "India",
        "audience": {
            "@type": "Audience",
            "audienceType": "AKTU B.Tech students"
        }
    };
    return (
        <div className="min-h-screen bg-slate-50">
            <SEO
                title="About AKTU PYQ — Free Study Materials for AKTU Students"
                description="Learn about AKTU PYQ — the free, ad-free platform built by students for AKTU B.Tech students offering PYQs, quantum notes, handwritten notes & official syllabus."
                canonicalUrl="https://www.aktupyq.com/about"
                schema={orgSchema}
            />
            <Header />
